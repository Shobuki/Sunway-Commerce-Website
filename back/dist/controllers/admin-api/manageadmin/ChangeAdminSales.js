...
exports.GetListSales = exports.changeAdminSalesStatus = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
class Admin {
    constructor() {
        this.changeAdminSalesStatus = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (isSales) {
                    ...
                    if (admin.Sales) {
                        const hasDealerAssociation = yield prisma.dealer.findFirst({
                        ...
                        yield prisma.sales.delete({ where: { AdminId: admin.Id } });
                    }
        ...
        this.GetListSales = (req, res) => __awaiter(this, void 0, void 0, function* () {
            try {
...
exports.changeAdminSalesStatus = adminController.changeAdminSalesStatus;
exports.GetListSales = adminController.GetListSales;
