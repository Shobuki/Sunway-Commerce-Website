...
exports.deleteItemCode = exports.updateItemCode = exports.createItemCode = exports.getItemCodeById = exports.getItemCodeByPartNumber = exports.getAllItemCodeWithPartNumbers = void 0;
const client_1 = require("@prisma/client");
const prisma = new client_1.PrismaClient();
class ItemCode {
    constructor() {
        this.getAllItemCodeWithPartNumbers = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
        ...
        this.getItemCodeByPartNumber = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const ItemCodeList = yield prisma.itemCode.findMany({
                    where: {
                ...
                res.status(200).json({
                    ...
                    data: ItemCodeList.map((item) => (Object.assign(Object.assign({}, item), { AllowItemCodeSelection: item.AllowItemCodeSelection, MinOrderQuantity: item.MinOrderQuantity, OrderStep: item.OrderStep }))),
                });
            }
            catch (error) {
        ...
        this.getItemCodeById = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { Id } = req.params;
                ...
                const ItemCodeData = yield prisma.itemCode.findFirst({
        ...
        this.createItemCode = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { PartNumberId, Name, OEM, Weight, AllowItemCodeSelection = false, MinOrderQuantity, OrderStep } = req.body;
                if (!PartNumberId || isNaN(Number(PartNumberId))) {
                ...
                const newItemCode = yield prisma.itemCode.create({
                    data: {
        ...
        this.updateItemCode = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { Id } = req.params;
                ...
                let partNumber = null;
                if (PartNumberId) {
                    partNumber = yield prisma.partNumber.findUnique({
                ...
                const updatedItemCode = yield prisma.itemCode.update({
                    where: { Id: Number(Id) },
                    data: {
                        Name,
                        OEM,
        ...
        this.deleteItemCode = (req, res, next) => __awaiter(this, void 0, void 0, function* () {
            try {
                const { Id } = req.params;
                ...
                const existingItemCode = yield prisma.itemCode.findUnique({
                    where: { Id: ItemCodeId },
                });
                if (!existingItemCode) {
                    res.status(404).json({ message: "ItemCode not found." });
...
exports.getAllItemCodeWithPartNumbers = itemCodeController.getAllItemCodeWithPartNumbers;
exports.getItemCodeByPartNumber = itemCodeController.getItemCodeByPartNumber;
exports.getItemCodeById = itemCodeController.getItemCodeById;
exports.createItemCode = itemCodeController.createItemCode;
exports.updateItemCode = itemCodeController.updateItemCode;
exports.deleteItemCode = itemCodeController.deleteItemCode;
exports.default = {
    getAllItemCodeWithPartNumbers: exports.getAllItemCodeWithPartNumbers,
    getItemCodeByPartNumber: exports.getItemCodeByPartNumber,
    getItemCodeById: exports.getItemCodeById,
    createItemCode: exports.createItemCode,
    updateItemCode: exports.updateItemCode,
    deleteItemCode: exports.deleteItemCode,
};
