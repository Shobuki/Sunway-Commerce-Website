...
const Register = () => {
  ...
  setError('');
  try {
    const response = await fetch('/api/dealer/dealer/register', {
      method: 'POST',
      headers: { 'Content-Type': 'application/json' },
      body: JSON.stringify({
        email, username, password, name, phoneNumber,
        address, birthdate, country, gender, province
      }),
    });
  ...
  return (
    <>
      <Navbar />
    <div className="min-h-screen bg-gray-100 flex items-center mt-10 py-10 px-2 justify-center">
